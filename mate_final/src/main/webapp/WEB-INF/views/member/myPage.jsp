	...
	<div class="row">
		<div class="col-sm-6">
		  <ul class="nav nav-pills" >
		    <li class="active" style="width:50%"><a aria-expanded="true" class="btn btn-lg btn-default nav-link active" data-toggle="tab" href="#buy" aria-selected="true">구매내역</a></li> 
