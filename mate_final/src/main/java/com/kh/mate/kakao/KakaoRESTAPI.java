...
public class KakaoRESTAPI {
	...
	private final static String K_CLIENT_ID = "9e0e7216cd163ae4e964775833931e12";
...
//		log.debug("kakakoUrl= {}",kakaoUrl);
	...
	public static JsonNode getAccessToken(String authorize_code) {
		...
		postList.add(new BasicNameValuePair("client_id", "9e0e7216cd163ae4e964775833931e12"));
