...
//		return erpDAO.selectRequsestList(empId);
//	}
	@Override
	public List<RequestLog> selectRequestList(Pagebar pb) {
		int totalContents = erpDAO.countRequestList(pb);
		pb.setTotalContents(totalContents);
		List<RequestLog> list = erpDAO.selectRequestList(pb);
		return list;
	}
...
//	}
	...
	public List<Map<String, Object>> selectRequestMapList(Pagebar pb) {
		int totalContents = erpDAO.countRequestLog(pb);
		pb.setTotalContents(totalContents);
		List<Map<String, Object>> list = erpDAO.selectRequestMapList(pb);
		return list;
	}
